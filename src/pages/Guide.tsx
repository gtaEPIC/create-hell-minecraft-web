  ...
  return (
    <PageLayout>
      <div className="guide-section">
        ...
        <div className="my-4">
          <a href="/modpacks/Create%20Hell%201.7.1.mrpack" download className="btn btn-primary">
        ...
        <div className="my-4">
          <a href="/modpacks/Create%20Hell%201.7.1%20Curseforge.zip" download className="btn btn-outline-primary">
            <i className="bi bi-download me-2"></i>
            Download .zip File
          </a>
        </div>
